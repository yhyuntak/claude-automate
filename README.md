...
### Phase 1: 병렬 리뷰 에이전트 (진행 예정)

Kieran Klaassen 스타일의 병렬 리뷰 시스템 구축:

- [ ] **phase1-001**: 병렬 리뷰 에이전트 구조 설계
- [ ] **phase1-002**: Triage 워크플로우 구현
- [ ] **phase1-003**: 리뷰 결과 학습 축적

### Phase 2: PARA 지식 관리

배운 것을 축적하는 시스템:

- [ ] Projects, Areas, Resources, Archive 구조
- [ ] 세션에서 인사이트 자동 추출
- [ ] 지식 검색 및 활용
